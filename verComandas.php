<?php 
  ...
  $st = $conn->prepare("SELECT * FROM comand WHERE status='Procesada' and chef_id=?");
         ...
         if(empty($num)){
            ...
            foreach ($num as $v) {
              ...
              echo "
                ...
                <div class=\"col-md-3\">
                      <button type=\"submit\" class=\"btn btn-default\" onclick=\"actualizar(".$v->id.")\">Terminada</button>
                </div>
              </div>";
              //echo $v->id;
            }
