<?php 
  ...
  $st = $conn->prepare("SELECT * FROM comand WHERE status='Recibida' and waiter_id=?");
              ...
              echo "
                ...
                <div class=\"col-md-3\">
                    <form action=\"pdf_cuenta.php\" method=\"post\" accept-charset=\"utf-8\" target=\"_blank\">
                      ...
                      <button type=\"submit\" class=\"btn btn-default\" onclick=\"actualizar(".$v->id.")\">Cuenta</button>
                    </form>
                </div>
              </div>";
              //echo $v->id;
...
<script>
  function actualizar(id) {
    //alert(id);
    $.ajax({
          url: "updatefinish.php",
          data: {id:id},
          type: 'post',
          beforeSend: function () {
          },
          success: function(){
            location.href="enviarCajero.php"; 
          },
          error: function(data){
